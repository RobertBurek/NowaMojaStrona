const dyplomyPion = [];
dyplomyPion[11] = ['img/Dyplomy/OcenaKompetencjiZawodowychDC_altkom.jpg']
dyplomyPion[10] = ['img/Dyplomy/RoleWZespoleProgramistycznym_altkom.jpg']
 dyplomyPion[9] = ['img/Dyplomy/Wzorce projektowe, narzędzia pracy grupowej_altkom.jpg']
 dyplomyPion[8] = ['img/Dyplomy/AplikacjeWeboweWJezykuJava.jpg']
 dyplomyPion[7] = ['img/Dyplomy/BazyDanychRelacyjneINierelacyjneJęzykSQL_altkom.jpg']
 dyplomyPion[6] = ['img/Dyplomy/PodstawyProgramowania-BackEnd_altkom.jpg']
 dyplomyPion[5] = ['img/Dyplomy/EComerceWPraktyce_uouw.jpg']
 dyplomyPion[4] = ['img/Dyplomy/CertyfikatGIT_eduwebpl.jpg']
 dyplomyPion[3] = ['img/Dyplomy/AngOdZeraDoBohatIA2_uouw.jpg']
 dyplomyPion[2] = ['img/Dyplomy/AngielskiPoLatachA1_uouw.jpg']
 dyplomyPion[1] = ['img/Dyplomy/AngOdZeraDoBohatIIIA1A2_uouw.jpg']
